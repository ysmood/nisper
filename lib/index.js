"use strict";
const nisp_1 = require("nisp");
const encode_1 = require("nisp/lib/encode");
...
exports.default = opts => {
    ...
    function genOnMessage(ws, env) {
        return msg => {
            ...
            return yaku_1.default.resolve(env).then(env => {
    ...
    function call(ws, nisp) {
        ...
        if (isDebug)
            var error = new Error();
        return new yaku_1.default((resolve, reject) => {
            send(ws, callData);
            sessions[id] = {
                resolve,
                reject,
    ...
    if (isClient) {
        ...
        clientCallx = function (...args) {
            const nisp = encode_1.default(...args);
    ...
    function middleware(req, res) {
        return yaku_1.default.all([
            onRequest(req, res),
            new yaku_1.default((resolve, reject) => {
